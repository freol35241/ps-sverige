...
TOPIC_INFO = {
    ...
    20: ("Författnings- och valfrågor",
         "Författningsfrågor och hur val ska genomföras"),
    21: ("Bostadspolitik",
         "Bostadspolitik"),
    ...
    25: ("Idrott, friluftsliv, alkohol- och narkotikapolitik",
